    ...
    <>
      ...
      >
        ...
        <button
          ...
          style={{
            width:38, height:38, borderRadius:6, border:'none', cursor:'pointer',
        ...
        <button
          ...
          style={{
            fontWeight:700, fontSize:18, letterSpacing:'0.07em',
        ...
        <div className="nav-desktop-links" style={{ display:'flex', flex:1, position:'relative', height:60, alignItems:'center' }}>
          ...
          <div onMouseEnter={open} style={{ height:'100%', display:'flex', alignItems:'center' }}>
            <button style={{
              ...
              borderBottom: mega ? `2px solid ${C.ink}` : '2px solid transparent',
          ...
          {QUICK_CATS.map(id => (
            <button key={id} onClick={() => goTo(id)} style={{
              ...
              background:'none', border:'none', cursor:'pointer',
              fontSize:13, fontWeight:400, color:C.ink,
          ...
          {[['Sale', C.sale, 600], ['New In', C.ink, 500]].map(([l, col, fw]) => (
            <button key={l} style={{
              height:'100%', padding:'0 12px',
              background:'none', border:'none', cursor:'pointer',
              fontSize:13, fontWeight:fw, color:col,
          ...
          {mega && (
            <div
              ...
              style={{
                ...
                background:C.canvas,
                border:`1px solid ${C.hairline}`, borderTop:`2.5px solid ${C.ink}`,
                padding:'20px 24px 18px',
                boxShadow:'0 12px 36px rgba(0,0,0,0.09)',
                zIndex:300, minWidth:520,
                animation:'slideDown 0.15s ease',
              }}
            >
              <div style={{ fontSize:10, fontWeight:600, letterSpacing:'0.12em', color:C.mute, textTransform:'uppercase', marginBottom:14 }}>
                All Departments
              </div>
                ...
                {Object.values(CAT_META).map(cat => (
                  <button
                    ...
                    style={{
                      ...
                      gap:4, padding:'9px 11px', borderRadius:6,
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.querySelectorAll('span').forEach(s => s.style.color = '#fff')
                    }}
                    onMouseLeave={e => {
        ...
        <div style={{ display:'flex', alignItems:'center', gap:2, marginLeft:'auto' }}>
          ...
          <div
            ...
            style={{
              ...
              background:C.cloud, borderRadius:9999,
              padding:'6px 14px', height:36, minWidth:170, cursor:'text',
            }}
          >
            <Search />
          ...
          <button
            ...
            style={{
              ...
              background:'transparent', color:C.ink, flexShrink:0,
            }}
          >
            <Search />
          </button>
          ...
          {userType === 'vendor' && (
            <button
              ...
              style={{
                display:'flex', alignItems:'center', gap:5,
                background: view === 'vendor' ? C.ink : C.cloud,
                color: view === 'vendor' ? '#fff' : C.ink,
                fontSize:12, fontWeight:500,
                padding:'6px 12px', borderRadius:9999, border:'none', cursor:'pointer',
                transition:'all 0.15s', marginLeft:4, flexShrink:0,
              }}
            >
              <Store /> My Store
            </button>
      ...
      {mobileOpen && (
        <div className="mobile-menu" style={{ zIndex:299 }}>
          ...
          <div style={{
            ...
            background:C.canvas,
            paddingTop:72, /* below the sticky nav */
            maxHeight:'100dvh',
            overflowY:'auto',
            ...
            <div style={{ padding:'16px 20px 8px' }}>
              <div style={{ fontSize:10, fontWeight:700, letterSpacing:'0.12em', color:C.mute, textTransform:'uppercase', marginBottom:12 }}>
                All Departments
              </div>
