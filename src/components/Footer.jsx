    ...
    <footer style={{ background:C.canvas, borderTop:`1px solid ${C.hairline}`, padding:'clamp(32px,4vw,48px) clamp(16px,4vw,40px) clamp(20px,3vw,28px)' }}>
      <div style={{ maxWidth:1440, margin:'0 auto' }}>
        <div className="footer-grid">
            ...
            <div style={{ display:'flex', gap:8 }}>
              <input
                ...
                style={{
                  ...
                  border:`1px solid ${C.hairline}`, fontSize:13,
                  outline:'none', background:C.cloud, minWidth:0,
                }}
              ...
              <button style={{
                ...
                padding:'8px 16px', borderRadius:9999, border:'none', cursor:'pointer', flexShrink:0,
              }}>
                Subscribe
              </button>
            </div>
          ...
          {COLS.map(col => (
            <div key={col.h}>
              <div style={{ fontSize:13, fontWeight:600, marginBottom:14, letterSpacing:'0.02em' }}>
                {col.h}
              </div>
              {col.links.map(l => (
                <a
                  key={l} href="#"
                  style={{ display:'block', fontSize:13, color:C.mute, marginBottom:9, transition:'color 0.15s' }}
        ...
        <div style={{
          borderTop:`1px solid ${C.hairline}`, paddingTop:20,
          ...
          <div style={{ display:'flex', gap:18 }}>
            {['Privacy','Terms','Cookies','Accessibility'].map(l => (
              <a key={l} href="#"
                style={{ fontSize:11, color:C.stone, transition:'color 0.15s' }}
                onMouseEnter={e => e.currentTarget.style.color = C.ink}
